    ...
    <div class="row">
      <div class="col-md-6 login-form-1 offset-md-3">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <input type="submit" class="btnSubmit" value="Şifremi Değiştir 😉" />
          </div>
  ...
  methods: {
    resetPassword() {
      if(this.password !== this.passwordAgain){
        this.errorMessage = "Şifreler birbirini tutmuyor! Lütfen, tekrar deneyin :)";
         this.showvar=true;
      setTimeout(() => { this.showvar=false; }, this.sec);
        return true;
      }
     if(this.password.length < 7){
        this.errorMessage = "Şifreniz minimum 8 karakter olabilir.";
         this.showvar=true;
      setTimeout(() => { this.showvar=false; }, this.sec);
        return true;
      }
      changePassword(this.token, this.password)
        .then(() => {
          this.errorMessage = "Şifreniz sıfırlandı!";
          this.showvar=true;
          setTimeout(() => { 
            this.showvar=false;
            this.$router.push("/"); 
        ...
        .catch(err => {
          ...
          if (err.response.status == 404) {
            this.errorMessage = "Şifre değiştirme işlemi geçersiz.";
          }
